...
describe("ClienteController", () => {
    ...
    beforeEach(() => {
        ...
        pedidoController = new PedidoController(pedidoRepository, cadastrosMicroserviceApi);
        mockRequest = {};
        mockResponse = {
    ...
    it("deve atualizar um pedido corretamente", async () => {
        ...
        await pedidoController.atualizar(mockRequest as Request, mockResponse as Response, mockNext);
    ...
    it("deve adicionar um item ao pedido corretamente", async () => {
        ...
        await pedidoController.adicionarItem(mockRequest as Request, mockResponse as Response, mockNext);
    ...
    it("deve buscar um pedido por ID corretamente", async () => {
        ...
        await pedidoController.buscarPorId(mockRequest as Request, mockResponse as Response, mockNext);
    ...
    it("deve buscar o status de pagamento de um pedido", async () => {
        ...
        await pedidoController.buscarStatusPagamento(mockRequest as Request, mockResponse as Response, mockNext);
    ...
    it("deve buscar todos os pedidos não finalizados", async () => {
        await pedidoController.buscarTodosPedidosNaoFinalizados(mockRequest as Request, mockResponse as Response, mockNext);
