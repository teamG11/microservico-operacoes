...
describe('PedidoRepository', () => {
    ...
    it('deve criar um pedido corretamente', async () => {
        const pedidoData = { id: 1, id_cliente: 1, valor_final: 100, tipo_pagamento: 'pix', status: 'recebido', status_pagamento: 'aguardando', 
    ...
    it('deve atualizar um pedido corretamente', async () => {
        const pedidoData = {
            id: 1, id_cliente: 1, valor_final: 100, tipo_pagamento: 'pix', status: 'recebido', status_pagamento: 'aguardando',
            created_at: new Date(), updated_at: new Date()
        };
    ...
    it('deve atualizar o status de um pedido corretamente', async () => {
        ...
        const pedidoData = {
            id: 1, id_cliente: 1, valor_final: 100, tipo_pagamento: 'pix', status: novoStatus, status_pagamento: 'aguardando',
            created_at: new Date(), updated_at: new Date()
        };
    ...
    it('deve encontrar todos os pedidos não finalizados corretamente', async () => {
        ...
        const pedidoData2 = {
            id: 1, id_cliente: 1, valor_final: 100, tipo_pagamento: 'pix', status: 'em preparacao', status_pagamento: 'aguardando',
            created_at: new Date(), updated_at: new Date()
        };
